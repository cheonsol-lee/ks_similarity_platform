...
def similarity_measure(A_keyword, A_index, B_keyword, B_index):
    A_list, A_avg = intra_sim(A_keyword, A_index)
    B_list, B_avg = intra_sim(B_keyword, B_index)
    AB_list, AB_avg = inter_sim(A_keyword, B_keyword, A_index, B_index)
